...
import cn.silince.common.valid.AddGroup;
import cn.silince.common.valid.UpdateGroup;
import cn.silince.common.valid.UpdateStatusGroup;
...
public class BrandController {
    ...
    /**
     * @description: 根据品牌id集合查询所有品牌名
     */
    @GetMapping("/infos")
    public R info(@RequestParam("brandIds") List<Long> brandIds){
        List<BrandVo> brands=brandService.getBrandsByIds(brandIds);
...
//        if (result.hasErrors()){HashMap<String, String> map = new HashMap<String, String>();
//            //1 获取校验的错误结果
